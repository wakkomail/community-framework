...
{
    public partial class ForumListSubForums : BaseForumUsercontrol
    {
        ...
        {
            var subcats = from sc in Factory.ReturnAllSubCategoriesInCategory(ParentCategoryId)
                          select sc;

            if (subcats.Any())
            {
                subforumlist.Visible = true;
