...
<asp:LoginView ID="lvEditItem" runat="server">
    <LoggedInTemplate>
        ...
        <p>
            <asp:TextBox ID="txtTitle" Rows="1" runat="server" ClientIDMode="Static"></asp:TextBox>
        </p>
        <p>
            Omschrijving
        </p>
        <p>
            <asp:TextBox ID="txtDescription" TextMode="MultiLine" Rows="4" runat="server" ClientIDMode="Static"></asp:TextBox>
        </p>
        <p>
            Datum
        </p>
